    ...
    return Scaffold(
         body: LayoutBuilder(
             builder: (BuildContext context, BoxConstraints constraints) {
               ...
               double itemHeight = isMobile ? 70.0 : 130.0; // Ajusta el alto de los elementos de la barra de navegación
               double textTitleSize = isMobile ? 18.0 : 30.0;
               double textButom = isMobile ? 9.0 : 16.0;
               double iconSize = isMobile ? 15.0: 30.0;
               double nameProject = isMobile ? 11.0 : 20.0;
           return Row(
            children: [
              SizedBox(
                width: barWidth,
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              'My Devices',
                              style: TextStyle(
                                  fontWeight: FontWeight.bold, fontSize: textTitleSize, color: Colors.black),
                            ),
                          ),
                          Row(
                            children: [
                              ElevatedButton(
                                ...
                                child: Text(
                                  '+New Device',
                                  style: TextStyle(fontSize: textButom),
                                ),
                              ),
                              const SizedBox(
                                width: 10,
